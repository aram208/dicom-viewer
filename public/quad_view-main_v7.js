...
// import vtkLiteHttpDataAccessHelper from 'vtk.js/IO/Core/DataAccessHelper/LiteHttpDataAccessHelper';
...
// import vtkITKHelper from 'vtk.js/Common/DataModel/ITKHelper';
...
async function update() {
  // const volumeArrayBuffer = await vtk.IO.Core.DataAccessHelper.vtkLiteHttpDataAccessHelper.fetchBinary(

  const volumeArrayBuffer = await vtk.IO.Core.DataAccessHelper.vtkHttpDataAccessHelper.fetchBinary(
  ...
  const vtkImage = vtk.Common.DataModel.vtkITKHelper.convertItkToVtkImage(itkImage);
